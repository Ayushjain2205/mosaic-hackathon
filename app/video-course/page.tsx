    ...
    const fetchCourseContent = async () => {
      ...
      try {
        ...
        if (storedCourse) {
          ...
          console.log("Video course data from localStorage:", courseData);

          // Check if the data has the expected structure (sections for video courses)
          if (
            ...
            if (response.ok) {
              ...
              console.log("Video course data from database:", dbCourseData);
