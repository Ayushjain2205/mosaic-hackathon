    ...
    const fetchCourse = async () => {
      try {
        ...
        if (storedCourse) {
          ...
          // Check if the data has the expected structure (slides for slides courses)

          if (
            courseData.type === "slides" &&
            (!courseData.slides || courseData.slides.length === 0)
          ) {
            ...
            if (response.ok) {
              ...
              setCourse(courseData); // Fallback to localStorage data
            }
          } else {
